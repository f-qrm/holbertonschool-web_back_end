...
async def wait_n(n: int, max_delay: int) -> List[float]:
    ...
    This function runs multiple instances of the wait_random coroutine concurrently
    using asyncio.as_completed to collect the results as they complete. It returns
    the list of delays in the order of completion (ascending), without explicitly sorting.
